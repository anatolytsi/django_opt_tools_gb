...
from mainapp.views import ProductsListView, get_products, products_ajax, category_choose
...
urlpatterns = [
    ...
    path("product/<int:pk>/", cache_page(3600)(ProductsListView.as_view()), name="product"),
